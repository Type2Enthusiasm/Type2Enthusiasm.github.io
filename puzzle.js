...
import {
  REWARD_BEAT1_MS,
  REWARD_BEAT2_STAGGER_MS,
  REWARD_BEAT3_STAGGER_MS,
  REWARD_BEAT_GAP_MS,
  REWARD_EASE,
  REWARD_ENTRANCE_MS,
  REWARD_REDUCE_MOTION_MS,
  REWARD_TILE_APPEAR_DELAY_MS,
  renderRewardQuotes
} from "./puzzle/reward.js";
...
function boot() {
  ...
  if (state.reward) {
    renderRewardQuotes(state.quoteStack);
  }
  bindEvents(state);
